...
from simgen.ldm.modules.diffusionmodules import UNetModel, TimestepBlock, ResBlock, Downsample, AttentionBlock, SingleTemporalRelation
# from ldm.modules.diffusionmodules.openaimodel import SpatialTransformer
from simgen.ldm import exists
...
class LocalResBlock(nn.Module):
    def __init__(
        ...
        if num_frames > 1:
            self.temporal_module1 = SingleTemporalRelation(out_channels, dropout=dropout, num_frames=num_frames)

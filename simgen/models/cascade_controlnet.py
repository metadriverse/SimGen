...
class UniControlNet(LatentDiffusion):
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        ...
        return x, dict(c_crossattn=[c], local_control=[local_conditions], global_control=[global_conditions], mask=[mask])
    ...
    def log_images(self, batch, N=4, n_row=2, sample=False, ddim_steps=50, ddim_eta=0.0, plot_denoise_rows=False,
                   plot_diffusion_rows=False, unconditional_guidance_scale=9.0, first_cond_model=None, split='val', strength=0.6,**kwargs):
